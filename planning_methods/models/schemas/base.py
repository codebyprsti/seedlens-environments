...
# Import Planning Methods schemas
from .planning_methods_schemas import (
    PlanningMethodsRequest,
    PlanningMethodsResponse,
    PlanVersionModel,
    PlanUpdateRequest,
    PlanUpdateResponse,
    DimensionOptionsResponse,
    ProgressiveOptionsResponse,
    PlanSummaryModel,
    PlanningDataModel,
    ConstraintBasedOutputModel,
    ConstraintModel,
    RangeModel
)
...
class YieldSummaryResponse(BaseModel):
    ...
    total_packed_qty: Optional[float] = None
    avg_productivity: Optional[float] = None
    forecast_1: Optional[float] = None
    forecast_2: Optional[float] = None
