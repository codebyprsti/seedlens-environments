...
from api.v1.endpoints import upload, category, full_data, category_filter_router, views, add_record, inspection, yield_summary, operations_drop_down, supply_chain_planning, seed_forecast_comparison, locations, agentic, sentinel
...
api_router.include_router(agentic.router, prefix="/agentic", tags=["Agentic AI"])
